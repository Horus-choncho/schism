...
class AnalyzeDataDialog(QDialog):
    ...
    def populate_analyses_tree(self):
        ...
        QTreeWidgetItem(cat_xy, ["One-phase exponential decay / association"])
        QTreeWidgetItem(cat_xy, ["Michaelis-Menten enzyme kinetics"])
        QTreeWidgetItem(cat_xy, ["Bland-Altman method comparison"])
        ...
        QTreeWidgetItem(cat_col, ["Kruskal-Wallis (and Dunn's post-hoc)"])
        QTreeWidgetItem(cat_col, ["One sample t and Wilcoxon test"])
        QTreeWidgetItem(cat_col, ["ROUT & Grubbs outlier detection"])
        QTreeWidgetItem(cat_col, ["ROC curve and AUC analysis"])
        ...
        QTreeWidgetItem(cat_grp, ["Repeated measures ANOVA"])
        QTreeWidgetItem(cat_grp, ["Nested one-way ANOVA"])
